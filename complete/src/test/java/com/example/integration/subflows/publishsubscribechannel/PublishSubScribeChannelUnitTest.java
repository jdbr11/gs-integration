...
import com.example.integration.subflows.publishsubscribechannel.PublishSubScribeChannelExample.NumbersClassifier;
import static org.junit.Assert.assertEquals;

import java.util.Arrays;

@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(classes={PublishSubScribeChannelExample.class})
