package com.example.integration.subflows.publishsubscribechannel;
...
public class PublishSubScribeChannelExample {
    ...
    public IntegrationFlow classify() {
        return flow -> flow.split()
                .publishSubscribeChannel(subscription -> subscription.subscribe(subflow -> subflow.
                        <Integer>filter(this::isMultipleOfThree).channel("multipleofThreeChannel")).subscribe(
                        subflow -> subflow.<Integer>filter(this::isRemainderOne)
